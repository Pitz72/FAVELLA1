...
### Regole a Due Oggetti (v0.2.0)
Puoi definire interazioni complesse tra due oggetti usando le preposizioni `su`, `con`, `contro`, `in`.
```markdown
# Manuale di Riferimento per FAVELLA 1 (v0.0.9)
...
**Sintassi:** `Invece di [VERBO] [OGGETTO 1] [PREPOSIZIONE] [OGGETTO 2]: dire "[TESTO]".`

**Esempio:**
```favella
Invece di usa la chiave con la porta: dire "La porta si apre con un click!".
...
**Tipi di Conseguenza:**
1.  **Cambio Proprietà:** `e adesso [OGGETTO] è [PROPRIETÀ].`
    *   Esempio: `e adesso la porta è aperta.`
2.  **Spostamento:** `e adesso [OGGETTO] è in [LUOGO].`
    *   Esempio: `e adesso la chiave è in inventario.`
3.  **Rimozione:** `e adesso [OGGETTO] è nel nulla.`
    *   Esempio: `e adesso la mela è nel nulla.`

**Esempio Completo:**
```favella
Invece di usa la chiave con la porta: dire "Click! La porta si apre." e adesso la porta è aperta.
```
