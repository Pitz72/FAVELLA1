...
// ====================================================================
//  «Programma con FAVELLA 1» — il playground del sito.
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <div className="flex flex-col rounded-2xl border border-favella-cyan/15 bg-favella-panel/60 p-3">
          <div
            ref={screenRef}
            className="crt-screen min-h-[420px] flex-1 overflow-y-auto rounded-xl border border-favella-cyan/15 bg-favella-void/95 px-5 py-4 font-mono text-[14px] leading-relaxed"
          >
            {fase === "pronto" && (
