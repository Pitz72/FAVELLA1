...
export const SEO_BY_PATH: Record<RoutePath, SeoEntry> = {
  "/": {
    ...
    description:
      "FAVELLA 1 è un linguaggio di programmazione open-source in cui l'italiano È il codice: scrivi avventure testuali con frasi in italiano. Versione 1.4.0, il linguaggio è completo. Parser LALR(1), 1097 test.",
    og: "/og/home.png",
    type: "website",
  },
  "/progetto": {
    ...
    description:
      "La visione dietro FAVELLA 1: un linguaggio in cui l'italiano è il codice. Ingegneria vera — parser LALR(1) a zero ambiguità, 1097 test — al servizio della narrativa interattiva.",
    og: "/og/progetto.png",
    type: "article",
  },
  "/aggiornamenti": {
