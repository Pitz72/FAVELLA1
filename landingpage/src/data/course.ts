...
// --------------------------------------------------------------------
//  La Galleria ufficiale: storie brevi, complete e vincibili, scritte
//  in italiano e giocabili qui col motore vero (Pyodide). I .fav sono
//  vendorati in public/favella-engine/galleria/<id>/ (= la stessa
//  cartella `galleria/` del pacchetto pip). Genere e difficoltà sono
//  presi dall'intestazione di ciascun .fav. Tutte VINCIBILI (collaudo
//  statico) e bootano sul motore v1.0.0.
// --------------------------------------------------------------------
